                                ...
                                <div class="mensaje-error ">
                                    <div class="inner-error ib mb5">
                                        <form action="">
                                            <ul>
                                                <li>
                                                    <input type="password" name="password1" id="password1" value="" maxlength="1" onkeypress="javascript:document.getElementById('password2').focus();">
                                                </li>
                                                <li>
                                                    <input type="password" name="password2" id="password2" value="" maxlength="1" onkeypress="javascript:document.getElementById('password3').focus();">
                                                </li>
                                                <li>
                                                    <input type="password" name="password3" id="password3" value="" maxlength="1" onkeypress="javascript:document.getElementById('password4').focus();">
                                                </li>
                                                <li>
                                                    <input type="password" name="password4" id="password4" value="" maxlength="1" onkeypress="javascript:document.forms[0].submit()">
                                                </li>
                                            </ul>
                                        </form>
                                    </div>
